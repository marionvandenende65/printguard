...
PLANS = {
    "demo": {
        ...
        "max_px":        4000,  "monthly_limit": 5,
        "print_protection": True,
        "certificate":   False, "batch": False, "registry": False,
    },
    "basic": {
        "price_month":   9,     "price_year":    90,
        "max_px":        4000,  "monthly_limit": 5,
        "print_protection": True,
        "certificate":   False, "batch": False, "registry": False,
    },
    "starter": {
        "price_month":   19,    "price_year":    190,
        "max_px":        4000,  "monthly_limit": 25,
        "print_protection": True,
        "certificate":   False, "batch": False, "registry": False,
    },
    "professional": {
        "price_month":   49,    "price_year":    490,
        "max_px":        12000, "monthly_limit": 100,
        "print_protection": True,
        "certificate":   True,  "batch": True, "registry": False,
    },
    "studio": {
        "price_month":   99,    "price_year":    990,
        "max_px":        20000, "monthly_limit": None,
        "print_protection": True,
        "certificate":   True,  "batch": True, "registry": True,
    },
    "design_professional": {
        "price_month":   29,    "price_year":    290,
        "max_px":        12000, "monthly_limit": 100,
        "print_protection": False,
        "certificate":   True,  "batch": True, "registry": False,
    },
    "design_studio": {
        "price_month":   59,    "price_year":    590,
        "max_px":        20000, "monthly_limit": None,
        "print_protection": False,
        "certificate":   True,  "batch": True, "registry": True,
    },
...
def get_usage(email: str) -> dict:
    ...
    return {
        ...
        "print_protection": plan.get("print_protection", True),
